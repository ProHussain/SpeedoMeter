package com.hazel.speedometer.ui.main.tabs.digital
...
import com.hazel.speedometer.databinding.FragmentDigitalBinding
...
class DigitalFragment : Fragment() {
    ...
    companion object {
        @JvmStatic
        fun newInstance() = DigitalFragment()
    }

    private lateinit var binding: FragmentDigitalBinding
    ...
    private fun initCollectors() {
        lifecycleScope.launch{
            viewModel.currentSpeed.collectLatest {
                binding.tvSpeed.text = String.format("%.1f", it)
            }
        }
